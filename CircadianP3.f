	...
	real*8 yij(ni,nj), tij(ni,nj)
      ...
      common /vcpoi/cpoi
    	...
    	open(unit =  5, file = 'CircadianDataP3.txt') 
    	open(unit =  6, file = 'CircadianDataP3_Time.txt') 
    	open(unit =  7, file = 'CircadianP3_Initial.txt')

    	open(unit = 11, file = 'CircadianP3_Output1.txt') 
    	open(unit = 12, file = 'CircadianP3_Output2.txt') 
    	open(unit = 13, file = 'CircadianP3_Output3.txt') 
    	open(unit = 14, file = 'CircadianP3_Output4.txt') 
    	open(unit = 15, file = 'CircadianP3_Output5.txt') 
    	open(unit = 16, file = 'CircadianP3_Output6.txt') 
    	open(unit = 17, file = 'CircadianP3_Output7.txt') 
    	open(unit = 18, file = 'CircadianP3_Output8.txt') 
    	open(unit = 19, file = 'CircadianP3_Output9.txt') 
      
    	open(unit = 21, file = 'CircadianP3_Output10.txt') 
    	open(unit = 22, file = 'CircadianP3_Output11.txt') 
    	open(unit = 23, file = 'CircadianP3_Output12.txt') 
    	open(unit = 24, file = 'CircadianP3_LPML.txt') 
