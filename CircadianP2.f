	...
	integer, parameter :: nt = 461
      integer, parameter :: iiniter = 1000, initer = 25000
	...
	real*8 yij(ni,nj), tij(ni,nj)
      ...
      common /vcpoi/cpoi
    	...
    	open(unit =  5, file = 'CircadianDataP2.txt') 
    	open(unit =  6, file = 'CircadianDataP2_Time.txt') 
    	open(unit =  7, file = 'CircadianP2_Initial.txt')

    	open(unit = 11, file = 'CircadianP2_Output1.txt') 
    	open(unit = 12, file = 'CircadianP2_Output2.txt') 
    	open(unit = 13, file = 'CircadianP2_Output3.txt') 
    	open(unit = 14, file = 'CircadianP2_Output4.txt') 
    	open(unit = 15, file = 'CircadianP2_Output5.txt') 
    	open(unit = 16, file = 'CircadianP2_Output6.txt') 
    	open(unit = 17, file = 'CircadianP2_Output7.txt') 
    	open(unit = 18, file = 'CircadianP2_Output8.txt') 
    	open(unit = 19, file = 'CircadianP2_Output9.txt') 
      
    	open(unit = 21, file = 'CircadianP2_Output10.txt') 
    	open(unit = 22, file = 'CircadianP2_Output11.txt') 
    	open(unit = 23, file = 'CircadianP2_Output12.txt') 
    	open(unit = 24, file = 'CircadianP2_LPML.txt') 
